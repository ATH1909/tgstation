...
/obj/item/toy/snowball
	...
	icon = 'icons/obj/toy.dmi'
	icon_state = "snowball"
	throwforce = 25 //deals slightly more stamina damage than a disabler shot, since snowballs are clumsier to use and harder to obtain than disablers
	damtype = STAMINA //maybe someday we can add stuffing rocks into snowballs to make them deal brute damage

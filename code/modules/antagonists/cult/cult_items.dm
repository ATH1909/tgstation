...
/obj/item/shuttle_curse/attack_self(mob/living/user)
	...
	if(totalcurses >= MAX_SHUTTLE_CURSES)
		...
		to_chat(user, "<span class='danger'><span class='big'>It seems that the cult has exhausted its ability to curse the emergency escape shuttle. It would be unwise to create more cursed orbs or to continue to try to shatter this one.</span></span>")
		return

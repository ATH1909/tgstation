...
/obj/item/shuttle_curse/attack_self(mob/living/user)
	...
	if(totalcurses >= MAX_SHUTTLE_CURSES)
		to_chat(user, "<span class='danger'>You try to shatter the orb, but it remains as solid as a rock!</span>")
		to_chat(user, "<span class='danger'><span class='big'>It seems that the emergency escape shuttle has already been cursed as many times as possible. It would be unwise to create more cursed orbs or to continue to try to shatter this one.</span></span>")
		return
